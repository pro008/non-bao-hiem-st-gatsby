    ...
    <Layout>
      ...
      <main className="page">
        ...
        <WhyChooseUs className="div-center">
          <h4 className="intro-section__title"><center>WHY CHOOSE US</center></h4>
          <p> Vì sao khách hàng chọn ST Helmet làm<br />nhà cung cấp sản phẩm nón bảo hiểm</p>
          <Container className="div-center mt-60">
            ...
            <div className="card-standard">
              <h5 className="text-image-block__subtitle is-inview">ST HELMET</h5>
              <p>Mục tiêu của ST Helmet là đảm bảo an toàn tuyệt đối và thoải mái cho người sử dụng</p>
              <ul>
        ...
        <h3 className='intro-section__title mt-60'><center>SẢN PHẨM</center></h3>
        <AllProductsV2 />
      </main>
    </Layout>
  )

      ...
      <Row className="custom-row">
        <Col md={5} xs={12}>
          <Container>
            ...
            <p className="text-white">Sản xuất mũ bảo hiểm quảng cáo theo thương hiệu uy tín hàng đầu Việt Nam</p>
            <LargeRedTransparentButton>GIỚI THIỆU VỀ CÔNG TY SƠN TÙNG</LargeRedTransparentButton>
          </Container>
        </Col>
        <Col md={7} xs={12}>
          <div>
